...
- **오전 감시 시작 시각 필터링(09:40 KST) 보완**:
  ...
  - **기본 출근 시각 변경 반영(11:30 -> 11:20 KST)**:
    - 냔냐님의 기본 출근 시각이 기존 11:30에서 **11:20 KST**로 변경됨에 따라 `src/config.py`의 `DEFAULT_SHIFT_SCHEDULE` 기본 출근 시각 및 주석, `src/main.py` 모드 주석을 **11:20**으로 일괄 반영 완료.
